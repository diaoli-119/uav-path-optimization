...
tic 	%Start stopwatch timer.tic starts a stopwatch timer to measure performance. The function records the internal time at execution of 
		%the tic command. Display the elapsed time with the toc function.
%----------------- optimizer ---------- fmincon -----------------------%
...
[td, tt, te] = compare_of(Path_bez,Bez_points,optimize_energy_use,optimize_time, D_eta_opt);
